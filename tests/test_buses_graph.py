...
class TestStopsData:
    ...
    async def test_stops_data_exists(self):
        """Test that stops data is defined."""
        assert len(graph.STOPS_DATA) > 0

    async def test_stop_has_required_fields(self):
...
class TestCreateRoute:
    ...
    async def test_create_route_offsets_cumulative(self):
...
class TestRouteDefinitions:
    ...
    async def test_red_routes_exist(self):
    ...
    async def test_green_routes_exist(self):
    ...
    async def test_nanda_routes_exist(self):
...
class TestRouteResolver:
    ...
    async def test_resolve_main_campus_red_uphill(self):
    ...
    async def test_resolve_main_campus_red_downhill(self):
    ...
    async def test_resolve_main_campus_red_downhill_from_gen2(self):
    ...
    async def test_resolve_main_campus_green_downhill(self):
    ...
    async def test_resolve_main_campus_green_from_gen2(self):
    ...
    async def test_resolve_nanda_route_up_route2(self):
...
class TestModels:
    ...
    async def test_stop_model(self):
        """Test Stop model."""
    ...
    async def test_bus_schedule_model(self):
    ...
    async def test_bus_detailed_schedule_model(self):
